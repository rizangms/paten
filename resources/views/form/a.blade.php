...
<div class="tab formulir">
	<div class="row">
		<div class="col-sm-6">
			NIK:
				<p><input class="form-control kedua" placeholder="NIK..." oninput="this.className = 'form-control'" name="nik" value="{{ ( isset( $data_meta['nik'] ) ? $data_meta['nik'] : '' ) }}" type="number" pattern=".{16,16}" title="16 Digit" ></p>
		</div>
		<div class="col-sm-6">
			KK:
				<p><input class="form-control kedua" placeholder="KK..." oninput="this.className = 'form-control'" name="kk" value="{{ ( isset( $data_meta['kk'] ) ? $data_meta['kk'] : '' ) }}" type="number" pattern=".{16,16}" title="16 Digit" ></p>
		</div>
	</div>
