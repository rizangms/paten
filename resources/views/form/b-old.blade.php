  ...
  <div class="modal-dialog modal-lg" role="document">
    ...
    <form id="perlengkapan" method="POST" action="{{ url('/kelengkapan-permohonan') }}">
      ...
      <div class="modal-body">
          ...
          <hr>
          <div class="form-group row">
            <label for="alamat_tujuan" class="col-lg-2 col-form-label align-self-center">Alamat Tujuan</label>
            <div class="col align-self-center">
              <textarea class="form-control" id="alamat_tujuan" name="alamat_tujuan" required required placeholder="">{{ ( isset( $data_meta['alamat_tujuan'] ) ? $data_meta['alamat_tujuan'] : '' ) }}</textarea>
            </div>
          </div>
          <hr>
          <div class="form-group row">
            <label for="alasan" class="col-lg-2 col-form-label align-self-center">Alasan Pindah / Tanggal Pindah</label>
            <div class="col-sm-6 col-lg-5 align-self-center">
              <input type="text" name="alasan" class="form-control" id="alasan" required placeholder="Alasan Pindah" value="{{ ( isset( $data_meta['alasan'] ) ? $data_meta['alasan'] : '' ) }}">
            </div>
            <div class="col-sm-6 col-lg-5 align-self-center">
              <input type="text" name="tanggal_pindah" class="form-control input_tanggalan" data-language='id' id="tanggal_pindah" required value="{{ ( isset( $data_meta['tanggal_pindah'] ) ? $data_meta['tanggal_pindah'] : '' ) }}">
            </div>
          </div>
          <hr>
          ...
          <hr>
          <div class="form-group row">
              <label for="keterangan" class="col-lg-2 col-form-label align-self-center">Keterangan</label>
              <div class="col-sm-12 col-lg-10 align-self-center">
                  <input type="text" name="keterangan" class="form-control" id="keterangan" required value="{{ ( isset( $data_meta['keterangan'] ) ? $data_meta['keterangan'] : '' ) }}">
              </div>
          </div>
