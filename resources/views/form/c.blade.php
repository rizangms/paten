...
<div class="tab formulir">
	...
	<div class="row">
		<div class="col">
			Keperluan:
				<p><input class="form-control" placeholder="Keperluan..." oninput="this.className = 'form-control'" name="keperluan" value="{{ ( isset( $data_meta['keperluan'] ) ? $data_meta['keperluan'] : '' ) }}"></p>
		</div>
	</div>
