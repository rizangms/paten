  ...
  <div class="modal-dialog modal-lg" role="document">
    ...
    <form id="perlengkapan" method="POST" action="{{ url('/kelengkapan-permohonan') }}">
      ...
      <div class="modal-body">
          ...
          <hr>
          <div class="form-group row">
              <label for="jenis_acara" class="col-lg-2 col-form-label align-self-center">Jenis Acara</label>
              <div class="col-sm-6 col-lg-5 align-self-center">
                  <input type="text" name="jenis_acara" class="form-control" id="jenis_acara" required value="{{ ( isset( $data_meta['jenis_acara'] ) ? $data_meta['jenis_acara'] : '' ) }}">
              </div>
          </div>
          <hr>
          <div class="form-group row">
              ...
              <div class="col-sm-12 col-lg-10 align-self-center">
                  <textarea class="form-control" id="keperluan" name="keperluan" required required placeholder="">{{ ( isset( $data_meta['keperluan'] ) ? $data_meta['keperluan'] : '' ) }}</textarea>
              </div>
          </div>
          <hr>
          <div class="form-group row">
            <label for="dari_tanggal" class="col-lg-2 col-form-label align-self-center">Berkalu Dari - Sampai</label>
            <div class="col-sm-6 col-lg-5 align-self-center">
              <input type="text" name="dari_tanggal" class="form-control input_tanggalan" data-language='en' required value="{{ ( isset( $data_meta['dari_tanggal'] ) ? $data_meta['dari_tanggal'] : '' ) }}">
            </div>
            <div class="col-sm-6 col-lg-5 align-self-center">
              <input type="text" name="sampai_tanggal" class="form-control input_tanggalan" data-language='en' required value="{{ ( isset( $data_meta['sampai_tanggal'] ) ? $data_meta['sampai_tanggal'] : '' ) }}">
            </div>
          </div>
