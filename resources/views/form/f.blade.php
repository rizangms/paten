...
<div class="tab formulir">
	...
	<div class="row">
		<div class="col-sm-6">
			Dari tanggal:
				<p><input class="form-control kedua input_tanggalan" placeholder="Tanggal lahir..." onchange="this.className = 'form-control'" name="dari_tanggal" value="{{ ( isset( $data_meta['dari_tanggal'] ) ? $data_meta['dari_tanggal'] : '' ) }}"></p>
		</div>
		<div class="col-sm-6">
			Sampai tanggal:
				<p><input class="form-control kedua input_tanggalan" placeholder="Tanggal lahir..." onchange="this.className = 'form-control'" name="sampai_tanggal" value="{{ ( isset( $data_meta['sampai_tanggal'] ) ? $data_meta['sampai_tanggal'] : '' ) }}"></p>
		</div>
	</div>
