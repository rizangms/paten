...
@section('content')
            ...
            <td colspan="2">
                <center>
                    <h2 style="margin: 0 1px "><u>SURAT PENGANTAR IZIN KERAMAIAN</u></h2>
            ...
            <td colspan="2" style="padding: 0 57px">
                <table id="khusus" width="100%">
                    ...
                    <tr>
                        ...
                        <td>Keperluan</td>
                        <td>:</td>
                        <td>Sebagai pengantar untuk mendapatkan Surat Izin Keramaian berupa {{ $data['jenis_acara'] }} mulai tanggal {{ $data['dari_tanggal'] }} sampai dengan {{ $data['sampai_tanggal'] }} dengan keperluan {{ $data['keperluan'] }}.</td>
                    </tr>
                </table>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <p class="p">
                    Orang tersebut di atas adalah benar-benar warga dari Kecamatan {{ $data['kecamatan'] }} dengan data seperti di atas.
                </p>
            </td>
        </tr>
        <tr>
